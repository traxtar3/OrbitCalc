...
def Rate2Arrive(Rate2ArriveHowManyDegreesAway, Rate2ArriveHowmanyDaystoArrive):
    ...
    Rate2Arrive_out = "To arrive in %.0f day(s) and 12 hours, drift at %.3f deg/day " \
                      "\nTo arrive on time, drift at %.3f deg/day " \
                      "\nTo arrive in %.0f day(s) and 12 hours, drift at %.3f deg/day" \
